...
urlpatterns = [
        ...
        path('l33t/', views.hardChallenges, name='hardChallenges'),
        path('l33t/deleteServer/', views.deleteServer, name='deleteServer'),
        path('l33t/adminLogin/', views.hardAdminLogin, name='hardAdminLogin'),
]
