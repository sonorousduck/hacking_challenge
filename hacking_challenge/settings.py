"""
Django settings for hacking_challenge project.
...
SECRET_KEY = '^4r)j(iwa$21&+pd3yc)e3d(np@(az6a2&(pwrr2j#^nyg9d=f'
...
ROOT_URLCONF = 'hacking_challenge.urls'
...
WSGI_APPLICATION = 'hacking_challenge.wsgi.application'
